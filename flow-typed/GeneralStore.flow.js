/**
 * Flowtype definitions for GeneralStore
 * Generated by Flowgen from a Typescript Definition
 * Flowgen v1.10.0
 * @flow
 */

declare module "GeneralStore" {
  import typeof * as DispatcherInstance from "GeneralStore/dispatcher/DispatcherInstance";

  import typeof * as InspectStore from "GeneralStore/store/InspectStore";

  import typeof StoreSingleton from "GeneralStore/store/StoreSingleton";

  import typeof StoreFactory from "GeneralStore/store/StoreFactory";

  declare export function define<T>(): StoreSingleton<T>;

  declare export function defineFactory<T>(): StoreFactory<T>;

  declare export { StoreFactory };

  declare export { default as connect } from "GeneralStore/dependencies/connect";

  declare export { default as connectCallback } from "GeneralStore/dependencies/connectCallback";

  declare export { default as useStoreDependency } from "GeneralStore/dependencies/useStoreDependency";

  declare export { DispatcherInstance, InspectStore };
}

declare module "GeneralStore/dispatcher/DispatcherInstance" {
...
declare module "GeneralStore/store/InspectStore" {
  import type { Dispatcher } from "flux";

  import type { StoreResponses } from "GeneralStore/store/Store";

  import typeof StoreFactory from "GeneralStore/store/StoreFactory";

  import typeof Store from "GeneralStore/store/Store";
...
declare module "GeneralStore/store/StoreSingleton" {
  import type { Dispatcher } from "flux";
...
declare module "GeneralStore/store/StoreFactory" {
  import type { Dispatcher } from "flux";
  ...
  import type Store, {
    ...
    StoreResponses,
    StoreResponse
  } from "GeneralStore/store/Store";

  declare export type StoreFactoryDefinition<T> = {
...
declare module "GeneralStore/dependencies/connect" {
  import type {
    DependencyMap,
    DependencyMapProps
  } from "GeneralStore/dependencies/DependencyMap";
...
declare module "GeneralStore/dependencies/connectCallback" {
  import type { DependencyMap } from "GeneralStore/dependencies/DependencyMap";
...
declare module "GeneralStore/dependencies/useStoreDependency" {
...
declare module "GeneralStore/store/Store" {
  import type { Dispatcher } from "flux";

  import typeof StoreFactory from "GeneralStore/store/StoreFactory";

  import typeof Event from "GeneralStore/event/Event";

  import typeof EventHandler from "GeneralStore/event/EventHandler";
...
__REDUX_DEVTOOLS_EXTENSION__: DevToolsExtension,
  ...
  declare export type StoreOptions<T> = {
    dispatcher: Dispatcher<any>,
...
declare module "GeneralStore/dependencies/DependencyMap" {
...
declare module "GeneralStore/event/Event" {
  import typeof EventHandler from "GeneralStore/event/EventHandler";
...
declare module "GeneralStore/event/EventHandler" {
  import typeof Event from "GeneralStore/event/Event";
